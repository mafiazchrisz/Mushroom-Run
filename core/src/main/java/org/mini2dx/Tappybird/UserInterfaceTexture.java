...
public class UserInterfaceTexture {
    ...
    private static final String NUMBER_0_LOCATION = "UserInterface/Numbers/number00.png";
    private static final String NUMBER_1_LOCATION = "UserInterface/Numbers/number11.png";
    private static final String NUMBER_2_LOCATION = "UserInterface/Numbers/number22.png";
    private static final String NUMBER_3_LOCATION = "UserInterface/Numbers/number33.png";
    private static final String NUMBER_4_LOCATION = "UserInterface/Numbers/number44.png";
    private static final String NUMBER_5_LOCATION = "UserInterface/Numbers/number55.png";
    private static final String NUMBER_6_LOCATION = "UserInterface/Numbers/number66.png";
    private static final String NUMBER_7_LOCATION = "UserInterface/Numbers/number77.png";
    private static final String NUMBER_8_LOCATION = "UserInterface/Numbers/number88.png";
    private static final String NUMBER_9_LOCATION = "UserInterface/Numbers/number99.png";

    private static final String GAME_OVER_TEXT_LOCATION = "UserInterface/GameOver.png"; // Default : textGaveOver.png
    private static final String PRESS_SPACE_TEXT_LOCATION = "UserInterface/PressSpace.png"; // Default : textPressSpace.png
    private static final String HIGHSCORE_TEXT_LOCATION = "UserInterface/HighScore.png"; // Default : textHighscore.png
